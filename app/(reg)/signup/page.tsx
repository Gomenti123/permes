      ...
      <div className='flex justify-center items-center w-full h-[100vh] ' >
        ...
        <form action={submited} className='flex flex-col gap-4'>
            ...
            <div className='flex flex-col gap-1'>
                ...
                <input required name='name' className='border outline-none border-neutral-500 rounded-sm p-1'  type="text" />
                <p className='text-[8px] font-semibold text-neutral-600'>Note: Make sure the name is the same as the name on your account details</p>
            </div>
            <div className='flex flex-col gap-1'>
                <label className='font-semibold text-[12px]'>Username</label>
                <input required name='username' className='border outline-none border-neutral-500 rounded-sm p-1'  type="text" />
            </div>
            <button className='p-3 bg-yellow-700 text-white text-[15px] flex items-center justify-center rounded-full'>{check ? <Spinner /> : "Register"}</button>
